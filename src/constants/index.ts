 ...
 * 项目logo
 */
export const SYSTEM_LOGO = 'https://img.tukuppt.com/png_preview/00/11/78/4b3nzHK5Us.jpg!/fw/780';

/**
 * 知识星球介绍
 */
export const GITHUB_LINK = 'https://github.com/Lick0920';

export const bilibili_LINK = 'https://space.bilibili.com/313316294?spm_id_from=333.1007.0.0';
